...
def book_restaurant_table(booking_time_start, number_guests, minutes_slot=90):
    """
    This method uses get_first_table_available to get the first table available, then it
    creates a Booking on the database.
    """
    table = get_first_table_available(booking_time_start, number_guests, minutes_slot)
